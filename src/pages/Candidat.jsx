        ...
        <table class="   table-auto w-full">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 ">المعدل </th>
                    <th class="py-3 px-6 ">اسم ولي الأمر </th>
                    <th class="py-3 px-6 ">لقب ولي الأمر</th>
                    <th class="py-3 px-6 ">مكان الميلاد </th>
                    <th class="py-3 px-6 ">تاريخ الميلاد </th>
              ...
              {Candidat.map((Candidat)=> 
                ...
                <td class="py-3 px-6 text-center">
                    ...
                    <td class="py-3 px-6 ">
                        ...
                        <td class="py-3 px-6 ">
                            <div class="flex items-center">
                            {demande && demande.filter((c) => c.num === parseInt(Candidat.num)).map((c) => c.MoyenneSc)[0]}

                            </div>
                        </td>
                        <td class="py-3 px-6 ">
                            <div class="flex items-center">
                            {demande && demande.filter((c) => c.num === parseInt(Candidat.num)).map((c) => c.prenomT)[0]}

                            </div>
                        </td>
                        <td class="py-3 px-6 ">
                            <div class="flex items-center">
                            {demande && demande.filter((c) => c.num === parseInt(Candidat.num)).map((c) => c.nomT)[0]}
