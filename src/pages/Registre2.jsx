...
const enreg = async (event) => {
  ...
  try {
    ...
    console.log(data);
    window.location.href = `/Registres2`;
            ...
            <table class="w-full table-auto">
                <thead>   
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-left"> النسب</th>
                              <th class="py-3 px-6 text-left"> الإسم  </th>
                    </tr>
                </thead>
...
<div class="bg-white shadow-md rounded my-6 ">
              ...
              <div class="text-center flex justify-between">
                ...
                <button class=" text-white right-0 absolute  my-2 inline-block rounded-full bg-neutral-200 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal  shadow-md transition duration-150 ease-in-out hover:bg-neutral-300 hover:shadow-lg focus:bg-neutral-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-neutral-400 active:shadow-lg peer-focus:text-primary dark:bg-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-500 dark:focus:bg-neutral-500 dark:active:bg-neutral-400 dark:peer-focus:text-primary mr-10" type="button"
                 style={{
                  backgroundColor: currentColor ,
                  }} onClick={enreg}
                >
