...
const enregistreract = async (event) => {
  event.preventDefault();
  console.log({
    activite, encadrant, type , tempsA, dateR,
  });
  try {
    const response = await fetch('http://127.0.0.1:8000/api/addActivite', {
      ...
      body: JSON.stringify({  activite, encadrant, type , tempsA, dateR })
    });
    const data = await response.json();
    console.log(data);
...
const enregistrerSeance = async (event) => {
  event.preventDefault();
  console.log({
    seance, 	prof, presence , debutS, finS, dateR,
  });
  try {
    const response = await fetch('http://127.0.0.1:8000/api/enregistrerSeance', {
      ...
      body: JSON.stringify({   seance, 	prof, presence ,debutS, finS, dateR})
    });
    const data = await response.json();
    console.log(data);
...
const enregistrerInfraction = async (event) => {
  event.preventDefault();
  console.log({
    infraction, raisonI, decision , tempsI, dateR,
  });
  try {
    const response = await fetch('http://127.0.0.1:8000/api/enregistrerInfraction', {
      ...
      body: JSON.stringify({  infraction, raisonI, decision , tempsI, dateR })
    });
    const data = await response.json();
    console.log(data);
...
const addAccident = async (event) => {
  event.preventDefault();
  console.log({
    accident, score, decisionA , tempsA, dateR,
  });
  try {
    const response = await fetch('http://127.0.0.1:8000/api/addAccident', {
      ...
      body: JSON.stringify({   accident, score, decisionA , tempsA, dateR })
    });
    const data = await response.json();
    console.log(data);
